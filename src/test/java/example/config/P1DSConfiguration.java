...
public class P1DSConfiguration {
    ...
    @Primary
    @Bean("p1DataSource")
    public DataSource dataDataSource(@Qualifier("p1DataSourceProperties") MultiDataSourceProperties dataSourceProperties) {
    ...
    public SqlSessionTemplate dataSessionTemplate(@Qualifier("p1SqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
